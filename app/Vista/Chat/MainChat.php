...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    ...
    <link rel="stylesheet" href="/sild/Public/css/Estilo/styleChat.css">
...
<!-- COMIENZA CONTENIDO DEL CHAT -->
      <div class="container-fluid">

        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-comments"></i> Chat</h1>
        <p class="mb-4">Chatea con los usuarios.</p>
        <!-- DataTales Example -->
            ...
            <div id="frame">    
              <div id="sidepanel">
                <div id="profile">
                  ...
                  include ('Chat.php');
                  $chat = new Chat();
                  $loggedUser = $chat->getUserDetails($_SESSION["usuario"]['idUsuario']);
                  echo '<div class="wrap">';
                    $currentSession = '';
                    foreach ($loggedUser as $user) {
                    $currentSession = $user['current_session'];
                    echo '<img id="profile-img" src="/sild/Public/userpics/'.$user['avatar'].'" class="online" alt="" />';
              ...
              <div id="contacts"> 
                <?php
                echo '<ul>';
                  $chatUsers = $chat->chatUsers($_SESSION["usuario"]['idUsuario']);
              ...
              echo '<li id="'.$user['userid'].'" class="contact '.$activeUser.'" data-touserid="'.$user['userid'].'" data-tousername="'.$user['username'].'">';
                echo '<div class="wrap">';
                  ...
                  echo '<img src="/sild/Public/userpics/'.$user['avatar'].'" alt="" />';
                  echo '<div class="meta">';
                    echo '<p class="name">'.$user['username'].'<span id="unread_'.$user['userid'].'" class="unread">'.$chat->getUnreadMessageCount($user['userid'], $_SESSION["usuario"]['idUsuario']).'</span></p>';
      ...
      <div class="messages" id="conversation">    
        <?php
        echo $chat->getUserChat($_SESSION["usuario"]['idUsuario'], $currentSession);            
        ?>
      </div>
...
<script src="/sild/app/Vista/Chat/Chat.js"></script>
