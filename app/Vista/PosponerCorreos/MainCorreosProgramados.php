...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-clock"></i> Correos Programados</h1>
  <!-- <p class="mb-4">Puedes crear carpetas...</p> -->
  <!-- DataTales Example -->
  <div class="card shadow mb-3">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Todos los correos programados</h6>  
 <!--      <span class="float-right">
   ...
   <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="tablaTodosProgramados" width="100%" cellspacing="0">
        <thead>
          <tr>
            <th>Destinatario</th>
            <th>Asunto</th>
