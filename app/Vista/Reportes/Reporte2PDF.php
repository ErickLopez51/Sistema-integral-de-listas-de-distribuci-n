...
<head>
<meta charset="utf-8">
<title>Reporte de correos enviados por área '.$fecha_actual.'.pdf</title>
...
$html .='<h4>Lista de correos enviados por áreas.</h4>
</div>
</header>
<main>
...
<thead>
<tr>
<th class="desc">Área de envió</th>
<th class="qty">Porcentaje</th>
<th class="unit">Cantidad</th>
</tr>
</thead>';
$total=0;
foreach ($datosCorreos as $datos) {
	$html .='<tbody>
	<tr>
	<td class="desc"><h3>'.$datos['grupoDestinatario'].'</h3></td>
...
<tr>
<td colspan="0"></td>
<td colspan="0">Total de correos</td>
<td>'.$total.'</td>
</tr>
</tfoot>
</table>
...
$mpdf->Output('Reporte de correos enviados por área '.$fecha_actual.'.pdf','I');
?>