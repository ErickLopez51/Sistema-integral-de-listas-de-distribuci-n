...
<div class="container-fluid">
  <!-- Page Heading --> 
  <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-user-plus"></i> Alta Usuario</h1>
  <p class="mb-4">Formulario para el alta de usuario.</p>
  <!-- DataTales Example -->
...
<br>
  <div class="col text-center">
    <button  id="UsuarioAlta" type="submit" class="btn btn-outline-success btn-rounded waves-effect"><i class="fas fa-plus"></i> Registrar usuario</button>
  </div>
